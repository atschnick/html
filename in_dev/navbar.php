<?php
	...
	echo "<li class='menu-button' onclick=showSidebar()><a href='#'><svg xmlns='http://www.w3.org/2000/svg' height='26px' viewBox='0 -960 960 960' width='26px' fill='#1f1f1f'><path d='M120-240v-80h720v80H120Zm0-200v-80h720v80H120Zm0-200v-80h720v80H120Z'/></svg></a></li>";
	echo "</ul>";
	echo "</nav>";
?>
